        ...
        <swiper-slide>
          <app-mapa>
            <img
              ...
              loading="lazy"
              src="mapa-1.png"
              alt="Imagem mapa a Barbearia Vanguarda 1"
          /></app-mapa>
        </swiper-slide>
        <swiper-slide>
          <app-mapa>
            <img
              ...
              loading="lazy"
              src="mapa-2.jpg"
              alt="Imagem mapa a Barbearia Vanguarda 2"
          /></app-mapa>
        </swiper-slide>
        <swiper-slide>
          <app-mapa>
            <img
              ...
              loading="lazy"
              src="mapa-3.jpg"
              alt="Imagem mapa a Barbearia Vanguarda 3"
          /></app-mapa>
        </swiper-slide>
        <swiper-slide>
          <app-mapa>
            <img
              ...
              loading="lazy"
              src="mapa-4.jpg"
              alt="Imagem mapa a Barbearia Vanguarda 4"
          /></app-mapa>
        </swiper-slide>
      </swiper-container>
