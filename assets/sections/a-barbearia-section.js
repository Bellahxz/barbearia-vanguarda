...
export class ABarbeariaSection extends LitElement {
  static styles = [
    ...
    css`
      ...
      article {
        ...
        background-color: var(--tom-5, #ead8c7);
  ...
  render() {
    return html` 
      <app-titulo class="animate__animated animate__slower animate__delay-1s" data-toggle-class="animate__fadeInUp">A Barbearia</app-titulo>
      <app-bolinhas> </app-bolinhas>
      <app-quadro class="animate__animated animate__slow animate__delay-1s" data-toggle-class="animate__slideInRight">
        <img
          loading="lazy"
      ...
      <article class="animate__animated animate__slower animate__delay-1s" data-toggle-class="animate__slideInLeft">
        <app-paragrafo>
